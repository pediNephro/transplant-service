...
public class SurveillanceProtocolController {
    ...
    public SurveillanceProtocol getByTransplantId(@PathVariable Long transplantId){
        return service.findByTransplantId(transplantId);
    }

    @PostMapping("/transplant/{transplantId}")
    public SurveillanceProtocol createWithTransplant(@PathVariable Long transplantId,
                                                      @RequestBody SurveillanceProtocol e){
